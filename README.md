...
상단 개요(제목·소개·프로젝트/사례 수·기술·경험 목록)와 개발자 프로필 → 목차 → 프로젝트 소개 및 개별 사례 순서입니다. 별도의 광고형 히어로·대표 성과 카드·제품 갤러리는 두지 않습니다. 참고 화면은 각 프로젝트 소개에서 펼쳐 보며, 상세 사례는 문제 → 대안·선택 이유 → 구현·Mermaid → 결과 순서를 유지합니다.
