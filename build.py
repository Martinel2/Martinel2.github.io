...
<div class="work-layout"><aside class="toc"><div class="toc-inner"><p class="eyebrow">목차 <span>{len(DATA['cases']):02d}</span></p><nav aria-label="프로젝트 목차">{contents}<p class="toc-group">MORE</p><a class="toc-extra" href="#beyond"><span>{len(DATA["cases"]) + 1:02d}</span><span>코드 밖에서도 이어지는 경험</span><span class="toc-arrow">↗</span></a><a class="toc-extra" href="#writings"><span>{len(DATA["cases"]) + 2:02d}</span><span>{home_text("sections", "writingsTitle")}</span><span class="toc-arrow">↗</span></a></nav><div class="toc-foot"><a href="resume.pdf" target="_blank" rel="noopener">이력서 PDF ↗</a><a href="portfolio.pdf" target="_blank" rel="noopener">포트폴리오 PDF ↗</a></div></div></aside><div class="cases">{''.join(project_sections)}</div></div>
